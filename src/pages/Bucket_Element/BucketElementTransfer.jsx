import './BucketElementTransfer.css';
import React, { useState } from 'react';

const BucketElementTransfer = () => {
  const [bucket1, setBucket1] = useState(["Element 1", "Element 2", "Element 4", "Element5"]);
  const [bucket2, setBucket2] = useState(["Element 3", "Element 6"]);
  ...
  return (
    <div className="container">
      <div>
        <h2 className='text-uppercase'>Bucket 1</h2>
        <ul>
      ...
      <div>
        <h2 className='text-uppercase'>Bucket 2</h2>
        <ul>
...
export default BucketElementTransfer;
